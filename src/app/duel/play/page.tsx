  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden bg-[#080b12] text-white">
      ...
      <div className="relative z-10 mx-auto grid h-screen w-full max-w-[1600px] grid-cols-[clamp(300px,25vw,360px)_minmax(0,1fr)] items-center gap-2 overflow-hidden p-2">
        ...
        <main className="relative mx-auto flex h-[calc(100vh-16px)] max-h-[1000px] w-full max-w-[980px] flex-col overflow-hidden rounded-2xl border border-white/20 bg-[radial-gradient(circle_at_center,rgba(72,39,85,0.65),rgba(8,21,25,0.92)_70%)] p-2 shadow-[0_0_60px_rgba(91,33,182,0.22)]">
          ...
          <div className="relative flex min-h-0 flex-1 flex-col justify-center gap-1">
            ...
            <div className="mx-auto grid w-full max-w-[620px] grid-cols-[70px_1fr_70px] items-center gap-1.5 rounded-xl border border-red-400/15 bg-red-950/[0.08] p-1">
            ...
            <div className="mx-auto w-full max-w-[620px] rounded-xl border border-white/10 bg-black/45 px-3 py-2 shadow-lg backdrop-blur-sm">
            ...
            <div className="mx-auto grid w-full max-w-[620px] grid-cols-[70px_1fr_70px] items-center gap-1.5 rounded-xl border border-sky-400/20 bg-sky-950/[0.1] p-1">
              <div className="space-y-2">
                <EmptyZone accent="pink" />
                <div className="relative">
                  <EmptyZone accent="blue" />
